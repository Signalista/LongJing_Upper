...
void setup() 
{
  ...
  // Upper2 板载 LED 均为低电平点亮：LED2 常亮，LED1 定时翻转
...
void loop()
{
  ...
  static uint32_t lastLed1ToggleTime = millis();
  static bool led1Level = HIGH;

  uint32_t nowMs = millis();

  if (nowMs - lastLed1ToggleTime >= LED_TOGGLE_INTERVAL_MS) {
    lastLed1ToggleTime = nowMs;
    led1Level = !led1Level;
    digitalWrite(PIN_LED1, led1Level);
  }
